# Example of a python server that communicates with a C++ client
    ...
    #    I.e, topic_name = '/vrpn_client_node/<rigid-body-name>/pose'.
    # 3. Launch this python script via: python3 py_optitrack_server_send_only.py
...
class OptiTrackServer:
    ...
    def server_program(self):
        ...
        while not rospy.is_shutdown():
            ...
            print("Sent: ", self.pos[0], self.pos[1], self.pos[2], self.quat[0], self.quat[1], self.quat[2], self.quat[3])
